...
import type { AddTeacherForm, TeacherAttachment } from '@/components/Teachers/AddTeacher/types'
import { Button } from '@/components/UIKit/Button'

interface TeacherAttachmentsProps {
    form: AddTeacherForm
...
const TeacherAttachments = ({ form, setForm }: TeacherAttachmentsProps) => {
    ...
    const handleFileUpload = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        const newAttachments: TeacherAttachment[] = files.map((file) => {
            const attachment: TeacherAttachment = {
                file,
                fileName: file.name,
    ...
    return (
        <section className="border-t border-zinc-200 mt-5 px-6">
            <div className="flex flex-col gap-2 mb-4">
                <div className="mt-4">
                    <h3 className="text-sm font-medium text-gray-900">Teacher Attachments</h3>
                    <p className="mt-1 text-sm text-gray-500">
                        Upload documents, photos, or other files related to this teacher
                    </p>
                </div>
            </div>
            ...
            {form.attachments.length < 1 && (
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-primary-400 transition-colors">
                    <div className="text-center">
                        ...
                        <div className="mt-4">
                            <label htmlFor="teacher-attachments" className="cursor-pointer">
