...
import {
  BackendStudentData,
  Student,
} from '@/app/(portal)/students/[pid]/page';
...
export const genderOptions = ['all genders', 'male', 'female'];
...
const StudentsTable = ({ students, totalPages }: StudentsTableProps) => {
  ...
  const normalizedGenderFilter =
    genderFilter === 'all genders' ? null : genderFilter;
  ...
  return (
    <DataTable<Student, BackendStudentData>
      config={{
        ...
        queryDeps: [normalizedGenderFilter, normalizedGradeFilter],
      }}
