...
const BulkUploadFeedback = ({ bulkResult,  showBulkDetails, setShowBulkDetails, setBulkResult }: BulkUploadFeedbackProps) => {
    ...
    return (
        ...
        <div>
          ...
          <XCircleIcon aria-hidden="true" className="size-5 text-amber-700 mr-2" />
        </div> Upload failed. All {bulkResult.totalCount} class{bulkResult.totalCount === 1 ? '' : 'es'} already exist or failed validation.
                </span>
            )}
